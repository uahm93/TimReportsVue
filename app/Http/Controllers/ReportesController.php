...
class ReportesController extends Controller
{
    ...
    public function totalRFCEmisor($fechainicio, $fechafin, $estado)
    {
    ...
    public function totalEmisor($fechainicio, $fechafin, $estado)
    {
        ...
        if ($estado == 'EXITO') {
            ...
            foreach ($data as $usuario) {
                ...
                foreach ($resultado as $tabla) {
                    ...
                    $resultado = json_decode(json_encode($total), true);
